...
<section id="slider-entidades">
    ...
    <div class="slide-entid">
        <ul id="slider_carrusel">
            ...
            <a target="_blank" href="http://www.pcm.gob.pe/" target="_blank" title="Presidencia del Consejo de Ministros" >
            <img alt="Presidencia del Consejo de Ministros" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/pcm.png" /></a></div>
            </li>
            
            <li class="itemposts large-2"><div class="items">
            <a target="_blank" href="http://sgrd.pcm.gob.pe/" target="_blank" title="Secretaria de Gestion del Riesgo de Desastres" >
            <img alt="Secretaria de Gestion del Riesgo de Desastres" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/sec-ges-riesgos-desastres.png" /></a></div>
             ...
             <li class="itemposts small-3"><div class="items"><a target="_blank" href="http://www.senamhi.gob.pe/" title="SENAHMI" ><img alt="SENAHMI" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/senamhi.png" />
            </a></div>
            </li>

            <li class="itemposts small-1"><div class="items">
            <a target="_blank" href="http://www.igp.gob.pe/" title="IGP" >
            <img alt="IGP" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/igp.png" />
            </a></div>            
            </li>

            <li class="itemposts small"><div class="items">
            <a target="_blank" href="http://www.dhn.mil.pe/" title="Marina de Guerra, Dirección de Hidrografía y Navegación - DHN" >
            ...
            <li class="itemposts small-3"><div class="items">
            <a target="_blank" href="http://minagri.gob.pe/portal/" title="Ministerio de Agricultura y Riego" >
            ...
            <li class="itemposts small-3"><div class="items">
            <a target="_blank" href="http://www.ana.gob.pe/" target="_blank" title="Autoridad Nacional del Agua" >
            <img alt="ANA" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/ana.png" />
            </a></div>
            </li>
            
            <li class="itemposts medium"><div class="items">
            <a target="_blank" href="http://www.vivienda.gob.pe/" title="Ministerio de Vivienda, Construcción y Saneamiento" >
            ...
            <li class="itemposts midium-3"><div class="items">
            <a target="_blank" href="http://www.mtc.gob.pe/portal/inicio.html" title="Ministerio de Transportes y Comunicaciones" ><img alt="Ministerio de Transportes y Comunicaciones" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/min-transportes.png" /></a></div>
            </li>
            
            <li class="itemposts small-3"><div class="items">
            <a target="_blank" href="http://www.cip.org.pe/" target="_blank" title="Colegio de Ingenieros del Perú" >
