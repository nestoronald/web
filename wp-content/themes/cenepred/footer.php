...
<section id="slider-entidades">
    ...
    <div class="slide-entid">
        <ul id="slider_carrusel">
            ...
            <a href="http://sgrd.pcm.gob.pe/" target="_blank" title="Indeci" >
            <img alt="Indeci" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/indeci.png" /></a></div>
            </li>

             <li class="itemposts small-3"><div class="items"><a href="http://www.senamhi.gob.pe/" title="SENAHMI" ><img alt="SENAHMI" src="<?php echo get_template_directory_uri(); ?>/img/instituciones/senamhi.png" />
            </a></div>
            </li>
