			...
			<article>
				...
				<?php 
				 //$direc='http://cenepred.gob.pe/wp-content/themes/cenepred/includes/exportar.png';
				  //$direc='http://www.cenepred.gob.pe/wp-content/themes/cenepred/includes/exportar.png';
				?>
				<div align="right">
				<!--a href="http://www.cenepred.gob.pe/wp-content/themes/cenepred/includes/exportar_lista_excel.php"-->
				...
				<div class="entry-content">
					...
					<div id="contact-form">
						<?php if ( isset( $_POST['ct_submit'] ) ) : ?>
							...
							$unidad 			= noInjection($_POST['ct_unidad']);
							...
							$representante 		= noInjection($_POST['ct_rep']);
							$domicilio	 		= noInjection($_POST['ct_dir']);
							$departamento 		= noInjection($_POST['ct_dep']);
							$provincia	 		= noInjection($_POST['ct_prov']);
							$telefono	 		= noInjection($_POST['ct_telefono']);
              ...
              /*
							...
							if (isset($_POST['formato']) && is_array($_POST['formato']) ) {
							   ...
							   foreach ($_POST['formato'] as $formato) {
							      ...
							      //------Guarda Medio Solicita Información---------------------
						...
						<?php else: ?>
							...
							<center>
                                ...
                                <p>Nota: Si usted desea, puede descargar el formulario para presentarlo personalmente a nuestras oficinas, <a href="http://www.cenepred.gob.pe/web/wp-content/uploads/2014/01/formato-acceso.pdf">haga clic aquí</a>.</p>
