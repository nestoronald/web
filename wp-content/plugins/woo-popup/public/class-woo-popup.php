...
class WooPopup {
	...
	public function activated_woocommerce(){
		...
		if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
			global $woocommerce;
			$woocommerce_pp = $woocommerce->plugin_url() . '/assets/js/prettyPhoto/jquery.prettyPhoto.js';
      $test_url = @fopen($woocommerce_pp, 'r'); // test parameters

      if($test_url){
        $pp_dir['base'] = $woocommerce_pp;
      }else{
