...
function add_bp_pages(){
    ...
    if ( current_user_can( 'manage_options' ) )  {
        ...
        add_utility_page( 'Bulk Creator', 'Bulk Creator', 'manage_options', 'bulk-creator', 'bulk_creator', plugins_url('images/bulk-creator.png', __FILE__) );
...
function bulk_creator() {
    ...
    */
    ...
    echo '<link rel="stylesheet" type="text/css" href="'. plugins_url('css/bulk-creator.css', __FILE__) .'">';
    echo '<script src="'.plugins_url('js/bulk-creator.js', __FILE__).'"></script>';
