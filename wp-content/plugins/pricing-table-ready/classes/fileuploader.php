	...
	class fileuploaderPrt {
		...
		public function upload() {
            ...
            if (isset($upload['type']) && !empty($upload['type'])) {
                ...
                //$this->_fileInfo['id'] = framePrt::_()->getTable('files')->insert($data_to_store);
                $res = true;
        ...
        private function createFileName() {
            return utilsPrt::getRandStr(). '-'. utilsPrt::getRandStr(). '-'. utilsPrt::getRandStr(). '-'. utilsPrt::getRandStr();
        }
        /**
